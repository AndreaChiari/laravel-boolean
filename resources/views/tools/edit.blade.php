...
@section('content')
    <main>
        <div class="container">
            <h2 class="text-center mb-5">Modifica Tool</h2>
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="image_url" name="image_url"
                                placeholder="Image Url" value="{{ old('image_url', $tool->image_url) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="release_year" name="release_year"
                                placeholder="Release Year" value="{{ old('release_year', $tool->release_year) }}">
                        </div>
                    </div>
                    <div class="col">
                        {{-- Latest Version tool  --}}
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="latest_version" name="latest_version"
                                placeholder="Sale Date" value="{{ old('latest_version', $tool->latest_version) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="download_link" name="download_link"
                                placeholder="Sale Date" value="{{ old('download_link', $tool->download_link) }}">
                        </div>
                    </div>
                </div>
