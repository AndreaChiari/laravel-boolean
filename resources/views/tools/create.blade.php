...
@section('content')
    <main>
        <div class="container">
            <h2 class="text-center mb-5">Aggiungi Tool</h2>
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="image_url" name="image_url"
                                placeholder="Image Url" value="{{ old('image_url') }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="release_year" name="release_year"
                                placeholder="Release Year" value="{{ old('release_year') }}">
                        </div>
                    </div>
                    <div class="col">
                        {{-- Latest Version tool  --}}
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="latest_version" name="latest_version"
                                placeholder="Latest Version" value="{{ old('latest_version') }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="download_link" name="download_link"
                                placeholder="Download Link" value="{{ old('download_link') }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row cols-1">
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="supported_os" name="supported_os" rows="3" placeholder="Supported OS">{{ old('supported_os') }}</textarea>
                        </div>
                    </div>
                </div>
